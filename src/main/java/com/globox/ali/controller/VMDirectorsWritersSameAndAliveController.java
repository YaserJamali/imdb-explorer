...
public class VMDirectorsWritersSameAndAliveController extends BaseAbstractController<VMDirectorsWritersSameAndAliveEntity, VMDirectorsWritersSameAndAliveDto, String> {
}
